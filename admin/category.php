...
if ($_REQUEST['act'] == 'insert')
{
	...
	$cat['is_group_show']= !empty($_POST['is_group_show'])? intval($_POST['is_group_show']): 0; //ecmoban模板堂 --zhuo
	$cat['is_search_show']= !empty($_POST['is_search_show'])? intval($_POST['is_search_show']): 0; //ecmoban模板堂 --zhuo
	$cat['is_search_show_layout']= !empty($_POST['is_search_show_layout'])? intval($_POST['is_search_show_layout']): 0; //ecmoban模板堂 --zhuo
