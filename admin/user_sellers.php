...
function admin_seller($seller_id)
{
	...
	$sellerId = $GLOBALS['db']->getOne($sql);
	if($sellerId ==0)
	{
		...
		if($user_info)
		{
			$admin_info=array(
				...
				'add_time'=>gmtime(),
				'action_list'=>'goods_manage,remove_back,goods_auto,picture_batch,goods_export,goods_batch,ship_manage,shiparea_manage,order_os_edit,order_ps_edit,order_ss_edit,order_view,order_view_finished,sale_order_stats,booking,delivery_view,back_view,sale_order_stats',
