...
//app管理
$modules['01_app']['01_advert_list']       = 'app_manage.php?act=advert_list';         // 分类轮播图
...
$modules['02_cat_and_goods']['notice_log']          = 'notice_logs.php?act=list'; //降价通知日志
...
$modules['08_members']['13_user_baitiao_info']    	= 'user_baitiao_log.php?act=list'; //ecmoban模板堂 --wang
