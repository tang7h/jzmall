...
if ($_REQUEST['act'] == 'list')
{
    ...
    assign_query_info();
    $smarty->display('notice_logs.htm');
}
...
elseif ($_REQUEST['act'] == 'query')
{
    ...
    make_json_result($smarty->fetch('notice_logs.htm'), '',
...
function get_notice_logs()
{
    ...
    /* 获得总记录数据 */
    $sql = 'SELECT COUNT(*) FROM ' .$GLOBALS['ecs']->table('notice_log') . $where;
    ...
    /* 获取管理员日志记录 */
    $list = array();
    $sql  = 'SELECT * FROM ' .$GLOBALS['ecs']->table('notice_log').
