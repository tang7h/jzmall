...
function get_goodstype()
{
    ...
    if ($result === false)
    {
        ...
        /* 查询记录 */
        $sql = "SELECT t.*, COUNT(a.cat_id) AS attr_count,s.id as shop_id,s.shop_name ".
               "FROM ". $GLOBALS['ecs']->table('goods_type'). " AS t ".
               "LEFT JOIN ". $GLOBALS['ecs']->table('attribute'). " AS a ON a.cat_id=t.cat_id left join ".$GLOBALS['ecs']->table('seller_shopinfo')." as s on s.seller_id=t.seller_id ".
               "GROUP BY t.cat_id " .
