			...
			TTPopups.prototype={
				setup:function(){
					...
					var oWrap=document.createElement('div'),
						...
						oClose.style.cssText='margin:12px;*margin-top:-30px;width:17px;height:15px;float:right;background:url(themes/jingdong2014/images/close.png) no-repeat center;cursor:pointer';
						var h1 = h+4;
						var w1 = w+64
