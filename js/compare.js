...
//      var goods_img1 = document.getElementById('goods_img' + i);
      ...
      compare_goods.innerHTML = '<dt><a target="_blank" href="goods.php?id=' + this.data[key].d + '"><img src="' + this.data[key].g + '" width="50" height="50"></a></dt><dd><a target="_blank" class="diff-item-name" href="goods.php?id=' + this.data[key].d + '">' + this.data[key].n + '</a><span class="p-price"><strong>' + this.data[key].s + '</strong><a class="del-comp-item" style="visibility: visible;" OnClick="Compare.add(this,' + this.data[key].d + ', 0, 0, 0, 0, 0, 1)">删除</a></span></dd>';
