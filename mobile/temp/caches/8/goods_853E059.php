<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:63:"/data/home/hyu1472460001/htdocs/mobile/themes/default/goods.dwt";i:1;s:74:"/data/home/hyu1472460001/htdocs/mobile/themes/default/library/comments.lbi";i:2;s:77:"/data/home/hyu1472460001/htdocs/mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1435833540;s:8:"maketime";i:1435829940;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>Android开发秘籍进阶篇：Android 4编程入门经典+Android 4高级编程（第3版　套装共2册） _IT_科技_图书、音像、数字商品_知了购——购我所爱——知了mall</title>
...
<header id="header">
  ...
  <h1> 商品详情 </h1>
  <div class="header_r header_search"> <a class="ico_15" href="supertouch.php?act=share&content=Android开发秘籍进阶篇：Android 4编程入门经典+Android 4高级编程（第3版　套装共2册） &pic=../images/201407/goods_img/106_G_1406506885650.jpg"> 分享 </a> </div>
</header>
<section class="goods_slider">
  <div class="blank2"></div>
  <div id="slideBox" class="slideBox">
    <div class="scroller">
      <!--<div><a href="javascript:showPic()"><img src="../images/201407/thumb_img/106_thumb_G_1406506885979.jpg"  alt="Android开发秘籍进阶篇：Android 4编程入门经典+Android 4高级编程（第3版　套装共2册） " /></a></div>-->
      <ul>
      <li><a href="javascript:showPic()"><img alt="" src="../images/201407/source_img/106_G_1406506885485.jpg"/></a></li>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(106)" style="display: inline;">3</a>
  <div class="title">
  ...
  <ul>
        <li>商品品牌：<a class="price" href="brand.php?id=27" >德尔玛</a></li>
            <li>本店售价：<b class="price">￥128元</b>　    <del>￥154元</del> 
    </li>
     
	    <li>注册用户：<b class="price" id="ECS_RANKPRICE_1">￥128元</b></li>
        <li>vip：<b class="price" id="ECS_RANKPRICE_2">￥122元</b></li>
  ...
  <ul>
    <li>月销量：0件</li>
        <li>类似商家列表5个</li>
        <li><a href="brand.php?id=22">博深</a></li>
        <li><a href="brand.php?id=29">春花</a></li>
        <li><a href="brand.php?id=18">德龙</a></li>
        <li><a href="brand.php?id=16">惠人</a></li>
...
<div class="wrap">
  <section class="goodsBuy radius5">
    ...
    <div>请选择<span>产品特色 </span><i></i></div>
    ...
    <form action="javascript:addToCart(106)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
      <div class="fields">
        ...
        <ul class="ul2">
          ...
          <div class="items"> 
                        ...
                        <input type="checkbox" name="spec_2" value="29" id="spec_value_29" onclick="changePrice()" />
            <label for="spec_value_29">
            特色商品one [加 ￥1000.00元] </label>
                        <input type="checkbox" name="spec_2" value="30" id="spec_value_30" onclick="changePrice()" />
            <label for="spec_value_30">
            特色商品two [加 ￥1200.00元] </label>
      ...
      <div class="option" >
        ...
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(106)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(106);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="../images/201407/goods_img/106_G_1406506885650.jpg"> </div>
            <div id="right">
              <p>Android开发秘籍进阶篇：Android 4编程入门经典+Android 4高级编程（第3版　套装共2册） </p>
              <span> 加入数量： <b id="cartNum"></b></span> <span> 总计金额： <b id="cartPrice">￥0元</b></span> </div>
          </div>
...
<section class="s-detail">
  ...
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="js/transport.js"></script><script type="text/javascript" src="js/utils.js"></script>	<div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:106;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>  
  </div>
