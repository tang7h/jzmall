<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:58:"F:/web-root/zl_shop_server/mobile/themes/default/goods.dwt";i:1;s:69:"F:/web-root/zl_shop_server/mobile/themes/default/library/comments.lbi";i:2;s:72:"F:/web-root/zl_shop_server/mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1439225403;s:8:"maketime";i:1439221803;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>华帝(VATTI) ZTD110-i13001 嵌入式 消毒柜_消毒柜/洗碗机_大 家 电_家用电器_知了购——购我所爱——知了mall</title>
...
<header id="header">
  ...
  <h1> 商品详情 </h1>
  <div class="header_r header_search"> <a class="ico_15" href="supertouch.php?act=share&content=华帝(VATTI) ZTD110-i13001 嵌入式 消毒柜&pic=../images/201408/goods_img/120_G_1408036989509.jpg"> 分享 </a> </div>
</header>
<section class="goods_slider">
  <div class="blank2"></div>
  <div id="slideBox" class="slideBox">
    <div class="scroller">
      <!--<div><a href="javascript:showPic()"><img src="../images/201408/thumb_img/120_thumb_G_1408036989163.jpg"  alt="华帝(VATTI) ZTD110-i13001 嵌入式 消毒柜" /></a></div>-->
      <ul>
      <li><a href="javascript:showPic()"><img alt="" src="../images/201408/source_img/120_G_1408036989791.jpg"/></a></li>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(120)" style="display: inline;">1</a>
  <div class="title">
  ...
  <ul>
        <li>商品品牌：<a class="price" href="brand.php?id=8" >美的</a></li>
            <li>本店售价：<b class="price">￥1000元</b>　    <del>￥1200元</del> 
    </li>
     
	    <li>注册用户：<b class="price" id="ECS_RANKPRICE_1">￥1000元</b></li>
        <li>vip：<b class="price" id="ECS_RANKPRICE_2">￥950元</b></li>
  ...
  <ul>
    <li>月销量：0件</li>
        <li>类似商家列表5个</li>
        <li><a href="brand.php?id=64">康宝</a></li>
        <li><a href="brand.php?id=8">美的</a></li>
          </ul>
</section>
<div class="wrap">
  <section class="goodsBuy radius5">
    ...
    <form action="javascript:addToCart(120)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
      ...
      <div class="option" >
        ...
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(120)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(120);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="../images/201408/goods_img/120_G_1408036989509.jpg"> </div>
            <div id="right">
              <p>华帝(VATTI) ZTD110-i13001 嵌入式 消毒柜</p>
              <span> 加入数量： <b id="cartNum"></b></span> <span> 总计金额： <b id="cartPrice">￥1000元</b></span> </div>
          </div>
...
<section class="s-detail">
  ...
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="js/transport.js"></script><script type="text/javascript" src="js/utils.js"></script>	<div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:120;}554fcae493e564ee0dc75bdf2ebf94ca</div> </div>  
  </div>
