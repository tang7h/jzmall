...
<header id="header">
  ...
  <h1> 商品详情 </h1>
  <div class="header_r header_search"> <a class="ico_15" href="supertouch.php?act=share&content=志高(Chigo)JC-270L 压缩机恒温红酒柜 底层自由摆放/8月新款8层100瓶&pic=../images/201408/goods_img/115_G_1408036037399.jpg"> 分享 </a> </div>
</header>
<section class="goods_slider">
  <div class="blank2"></div>
  <div id="slideBox" class="slideBox">
    <div class="scroller">
      <!--<div><a href="javascript:showPic()"><img src="../images/201408/thumb_img/115_thumb_G_1408036037724.jpg"  alt="志高(Chigo)JC-270L 压缩机恒温红酒柜 底层自由摆放/8月新款8层100瓶" /></a></div>-->
      <ul>
      <li><a href="javascript:showPic()"><img alt="" src="../images/201408/source_img/115_G_1408036037004.jpg"/></a></li>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(115)" style="display: inline;">0</a>
  <div class="title">
    <h1> 志高(Chigo)JC-270L 压缩机恒温红酒柜 底层自由摆放/8月新款8层100瓶 </h1>
  </div>
  
  
  <ul>
        <li>商品品牌：<a class="price" href="brand.php?id=3" >志高</a></li>
            <li>本店售价：<b class="price">￥2250元</b>　    <del>￥2700元</del> 
    </li>
     
	    <li>注册用户：<b class="price" id="ECS_RANKPRICE_1">￥2250元</b></li>
        <li>vip：<b class="price" id="ECS_RANKPRICE_2">￥2138元</b></li>
  ...
  <ul>
    <li>月销量：0件</li>
        <li>类似商家列表5个</li>
        <li><a href="brand.php?id=66">维诺夫卡</a></li>
          </ul>
</section>
<div class="wrap">
  <section class="goodsBuy radius5">
    ...
    <form action="javascript:addToCart(115)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
      ...
      <div class="option" >
        ...
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(115)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(115);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="../images/201408/goods_img/115_G_1408036037399.jpg"> </div>
            <div id="right">
              <p>志高(Chigo)JC-270L 压缩机恒温红酒柜 底层自由摆放/8月新款8层100瓶</p>
              <span> 加入数量： <b id="cartNum"></b></span> <span> 总计金额： <b id="cartPrice">￥2250元</b></span> </div>
          </div>
...
<section class="s-detail">
  ...
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="js/transport.js"></script><script type="text/javascript" src="js/utils.js"></script>	<div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:115;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>  
  </div>
