...
<header id="header">
  ...
  <h1> 商品详情 </h1>
  <div class="header_r header_search"> <a class="ico_15" href="supertouch.php?act=share&content=教育&pic=../images/201412/goods_img/156_G_1418952353666.jpg"> 分享 </a> </div>
</header>
<section class="goods_slider">
  <div class="blank2"></div>
  <div id="slideBox" class="slideBox">
    <div class="scroller">
      <!--<div><a href="javascript:showPic()"><img src="../images/201412/thumb_img/156_thumb_G_1418952353372.jpg"  alt="教育" /></a></div>-->
      <ul>
      <li><a href="javascript:showPic()"><img alt="" src="../images/201412/source_img/156_G_1418952353298.jpg"/></a></li>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(156)" style="display: inline;">0</a>
  <div class="title">
    <h1> 教育 </h1>
  </div>
  ...
  <ul>
        <li>商品品牌：<a class="price" href="brand.php?id=30" >科沃斯</a></li>
            <li>本店售价：<b class="price">￥100元</b>　    <del>￥120元</del> 
    </li>
     
	    <li>注册用户：<b class="price" id="ECS_RANKPRICE_1">￥100元</b></li>
        <li>vip：<b class="price" id="ECS_RANKPRICE_2">￥95元</b></li>
    ...
    <form action="javascript:addToCart(156)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
      <div class="fields">
        ...
        <ul class="quantity">
          ...
          <input class="num" name="number" id="goods_number" autocomplete="off" value="1" min="1" max="10001" type="text">
      ...
      <div class="option" >
        ...
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(156)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(156);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="../images/201412/goods_img/156_G_1418952353666.jpg"> </div>
            <div id="right">
              <p>教育</p>
              <span> 加入数量： <b id="cartNum"></b></span> <span> 总计金额： <b id="cartPrice">￥100元</b></span> </div>
          </div>
...
<section class="s-detail">
  ...
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="js/transport.js"></script><script type="text/javascript" src="js/utils.js"></script>	<div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:156;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>  
  </div>
