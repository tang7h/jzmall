<?php exit;?>a:3:{s:8:"template";a:2:{i:0;s:66:"/data/home/hyu1472460001/htdocs/mobile/themes/default/category.dwt";i:1;s:77:"/data/home/hyu1472460001/htdocs/mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1435545404;s:8:"maketime";i:1435541804;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta charset="utf-8" />
<title>图书、音像、数字商品_知了购——购我所爱——知了mall</title>
  ...
  <div class="filter" style="position:static; top:0px; width:100%;">
    <form method="GET" class="sort" name="listform">
      <ul class="filter-inner">
        <li class="filter-cur"> <a href="category.php?category=1&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list">综合 </a> </li>
        <li class=""> <a href="category.php?category=1&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=click_count&order=#goods_list">人气 <i class="f-ico-arrow-d"></i> </a> </li>
        <li class=""> <a href="category.php?category=1&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_count&order=DESC#goods_list">销量</a></li>
        ...
        <div class="attrValues">
          <ul class="av-collapse filter_list">
                                      <li class="av-selected"> <a href="javascript:void(0);" data="0">全部</a></li>
                                                    ...
                                                    <li> <a href="javascript:void(0);" data="11">雷瓦</a></li>
                                                    <li> <a href="javascript:void(0);" data="16">惠人</a></li>
                                                    <li> <a href="javascript:void(0);" data="18">德龙</a></li>
                                                    <li> <a href="javascript:void(0);" data="22">博深</a></li>
                                                    <li> <a href="javascript:void(0);" data="27">德尔玛</a></li>
                                                    <li> <a href="javascript:void(0);" data="29">春花</a></li>
...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'category.php?act=asynclist&category=1&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC', 'spinner_code':'<div style="text-align:center; margin:10px;"><img src="themes/default/images/loader.gif" /></div>'})
