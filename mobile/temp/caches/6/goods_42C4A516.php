...
<header id="header">
  ...
  <h1> 商品详情 </h1>
  <div class="header_r header_search"> <a class="ico_15" href="supertouch.php?act=share&content=数据化管理：洞悉零售及电子商务运营 &pic=../images/201407/goods_img/103_G_1406506781461.jpg"> 分享 </a> </div>
</header>
<section class="goods_slider">
  <div class="blank2"></div>
  <div id="slideBox" class="slideBox">
    <div class="scroller">
      <!--<div><a href="javascript:showPic()"><img src="../images/201407/thumb_img/103_thumb_G_1406506781572.jpg"  alt="数据化管理：洞悉零售及电子商务运营 " /></a></div>-->
      <ul>
      <li><a href="javascript:showPic()"><img alt="" src="../images/201407/source_img/103_G_1406506781091.jpg"/></a></li>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(103)" style="display: inline;">0</a>
  <div class="title">
    <h1> 数据化管理：洞悉零售及电子商务运营  </h1>
  </div>
  
  
  <ul>
        <li>商品品牌：<a class="price" href="brand.php?id=11" >雷瓦</a></li>
            <li>本店售价：<b class="price">￥46元</b>　    <del>￥55元</del> 
    </li>
     
	    <li>注册用户：<b class="price" id="ECS_RANKPRICE_1">￥46元</b></li>
        <li>vip：<b class="price" id="ECS_RANKPRICE_2">￥44元</b></li>
  ...
  <ul>
    <li>月销量：0件</li>
        ...
        <li><a href="brand.php?id=58">惠氏</a></li>
          </ul>
</section>
<div class="wrap">
    ...
    <form action="javascript:addToCart(103)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
      <div class="fields">
        ...
        <ul class="quantity">
          ...
          <input class="num" name="number" id="goods_number" autocomplete="off" value="1" min="1" max="9997" type="text">
      ...
      <div class="option" >
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="../images/201407/goods_img/103_G_1406506781461.jpg"> </div>
            <div id="right">
              <p>数据化管理：洞悉零售及电子商务运营 </p>
              <span> 加入数量： <b id="cartNum"></b></span> <span> 总计金额： <b id="cartPrice">￥46元</b></span> </div>
          </div>
...
<section class="s-detail">
  ...
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="js/transport.js"></script><script type="text/javascript" src="js/utils.js"></script>	<div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:103;}554fcae493e564ee0dc75bdf2ebf94ca</div> </div>  
  </div>
