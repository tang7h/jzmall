<?php exit;?>a:3:{s:8:"template";a:2:{i:0;s:61:"F:/web-root/zl_shop_server/mobile/themes/default/category.dwt";i:1;s:72:"F:/web-root/zl_shop_server/mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1439221609;s:8:"maketime";i:1439218009;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta charset="utf-8" />
<title>创维_大 家 电_家用电器_知了购——购我所爱——知了mall</title>
  ...
  <div class="filter" style="position:static; top:0px; width:100%;">
    <form method="GET" class="sort" name="listform">
      <ul class="filter-inner">
        <li class="filter-cur"> <a href="category.php?category=90&display=grid&brand=1&price_min=1400&price_max=2400&filter_attr=1.0.15.40.0&page=1&sort=goods_id&order=DESC#goods_list">综合 </a> </li>
        <li class=""> <a href="category.php?category=90&display=grid&brand=1&price_min=1400&price_max=2400&filter_attr=1.0.15.40.0&page=1&sort=click_count&order=#goods_list">人气 <i class="f-ico-arrow-d"></i> </a> </li>
        <li class=""> <a href="category.php?category=90&display=grid&brand=1&price_min=1400&price_max=2400&filter_attr=1.0.15.40.0&page=1&sort=sales_count&order=DESC#goods_list">销量</a></li>
        <li class=""> <a href="category.php?category=90&display=grid&brand=1&price_min=1400&price_max=2400&filter_attr=1.0.15.40.0&page=1&sort=shop_price&order=ASC#goods_list">价格 <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb "></i> </span> </a> </li>
      ...
      <input type="hidden" name="filter_attr" value="1.0.15.40.0" />
    ...
    <div class="attrs attr-fix" style="overflow: auto;height: 100%">
        ...
        <div class="attrValues">
          <ul class="av-collapse filter_list">
                                      <li> <a href="javascript:void(0);" data="0">全部</a></li>
                                                    <li class="av-selected"> <a href="javascript:void(0);" data="1">创维</a></li>
        ...
        <div class="attrValues">
          <ul class="av-collapse filter_list">
                                      <li> <a href="javascript:void(0);" data="0|0">全部</a></li>
                                                    <li> <a href="javascript:void(0);" data="400|1400">400&nbsp;-&nbsp;1400</a></li>
                                                    <li class="av-selected"> <a href="javascript:void(0);" data="1400|2400">1400&nbsp;-&nbsp;2400</a></li>
        ...
        <div class="attrValues">
          <ul class="av-collapse filter_list">
                                  <li class="filter_attr"> <a href="javascript:void(0);" data="0">全部</a></li>
                                              <li class="av-selected filter_attr"> <a href="javascript:void(0);" data="1">1.5 P（约12-23㎡）</a></li>
        ...
        <div class="attrValues">
          <ul class="av-collapse filter_list">
                                  <li class="filter_attr"> <a href="javascript:void(0);" data="0">全部</a></li>
                                              <li class="av-selected filter_attr"> <a href="javascript:void(0);" data="15">32英寸智能</a></li>
        ...
        <div class="attrValues">
          <ul class="av-collapse filter_list">
                                  <li class="filter_attr"> <a href="javascript:void(0);" data="0">全部</a></li>
                                              <li class="av-selected filter_attr"> <a href="javascript:void(0);" data="40">fds</a></li>
...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'category.php?act=asynclist&category=90&brand=1&price_min=1400&price_max=2400&filter_attr=1.0.15.40.0&page=1&sort=goods_id&order=DESC', 'spinner_code':'<div style="text-align:center; margin:10px;"><img src="themes/default/images/loader.gif" /></div>'})
