<?php exit;?>a:3:{s:8:"template";a:2:{i:0;s:63:"/data/home/hyu1472460001/htdocs/mobile/themes/default/brand.dwt";i:1;s:77:"/data/home/hyu1472460001/htdocs/mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1435094181;s:8:"maketime";i:1435090581;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta charset="utf-8" />
<title>惠人_知了购——购我所爱——知了mall</title>
...
<div id="page" style="right: 0px; left: 0px; display: block;">
  ...
  <section class="order_box padd1 radius10">
    ...
    <tr>
      <td bgcolor="#ffffff" align="center" valign="middle"><img src="/data/brandlogo/1408388757754426015.jpg" /></td>
  ...
  <div class="filter" style="position:static; top:0px; width:100%;">
    <form method="GET" class="sort" name="listform">
      <ul class="filter-inner">
        <li class=""> <a href="brand.php?category=0&display=grid&brand=16&price_min=&price_max=&filter_attr=&page=1&sort=goods_id&order=DESC#goods_list">综合 </a> </li>
        <li class="filter-cur"> <a href="brand.php?category=0&display=grid&brand=16&price_min=&price_max=&filter_attr=&page=1&sort=click_count&order=DESC#goods_list">人气 <i class="f-ico-arrow-d"></i> </a> </li>
        <li class=""> <a href="brand.php?category=0&display=grid&brand=16&price_min=&price_max=&filter_attr=&page=1&sort=sales_count&order=DESC#goods_list">销量</a></li>
        <li class=""> <a href="brand.php?category=0&display=grid&brand=16&price_min=&price_max=&filter_attr=&page=1&sort=shop_price&order=ASC#goods_list">价格 <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb "></i> </span> </a> </li>
      </ul>
...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'brand.php?act=asynclist&category=0&brand=16&price_min=&price_max=&filter_attr=&page=1&sort=click_count&order=DESC', 'spinner_code':'<div style="text-align:center; margin:10px;"><img src="themes/default/images/loader.gif" /></div>'})
