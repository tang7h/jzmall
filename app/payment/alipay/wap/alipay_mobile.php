...
class ALIPAY_MOBILE
{
    ...
    {  
        ...
        $notify_url = $app_url."/payment/alipay/wap/notify_url.php";  //服务器异步通知页面路径
        $call_back_url = $app_url."/payment/wap_callback.php?code=alipay";  //页面跳转同步通知页面路径
        $merchant_url = $app_url."/payment/wap_merchant.php?code=alipay";  //操作中断返回地址
