...
$sql = "SELECT b.brand_id, b.brand_name, b.brand_logo, COUNT(g.goods_id) AS goods_num ".
       ...
       " WHERE g.is_on_sale = 1 AND g.is_alone_sale = 1 and g.is_display=1  AND g.is_delete = 0 AND b.brand_id > 0 " . $in_goods .
       " GROUP BY g.brand_id ";
...
$sql = "SELECT c.cat_id, c.cat_name, COUNT(g.goods_id) AS goods_num ".
       ...
       " WHERE g.is_on_sale = 1 AND g.is_alone_sale = 1 and g.is_display=1  AND g.is_delete = 0  " . $in_goods .
       " GROUP BY g.cat_id ";
