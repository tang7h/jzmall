...
E_D("replace into `ecs_group_goods` values('157','5','2749.00','1','1');");
E_D("replace into `ecs_group_goods` values('157','7','458.00','1','1');");
E_D("replace into `ecs_group_goods` values('157','8','1598.00','1','1');");
E_D("replace into `ecs_group_goods` values('157','11','199.00','1','1');");
E_D("replace into `ecs_group_goods` values('157','9','2699.00','1','1');");
E_D("replace into `ecs_group_goods` values('157','14','969.00','1','1');");
E_D("replace into `ecs_group_goods` values('157','19','109.00','1','1');");
