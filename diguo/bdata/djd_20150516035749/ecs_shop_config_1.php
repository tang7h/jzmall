...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','ACE商城','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','ACE商城','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','化妆品领先者','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','化妆品 莱琪尔','1');");
...
E_D("replace into `ecs_shop_config` values('108','1','shop_address','text','','','广东省广州市天河区中山大道1150号A2栋3505室','1');");
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','2114392403','1');");
...
E_D("replace into `ecs_shop_config` values('118','1','shop_logo','file','','../themes/{\$template}/images/','../themes/jingdong2014/images/logo.gif','1');");
...
E_D("replace into `ecs_shop_config` values('121','1','shop_notice','textarea','','','人人人人果然果然果然够烦人个人广告如果','1');");
...
E_D("replace into `ecs_shop_config` values('202','2','icp_number','text','','','京ICP证ace070359号','1');");
...
E_D("replace into `ecs_shop_config` values('239','2','certificate_id','hidden','','','1241193836','1');");
E_D("replace into `ecs_shop_config` values('240','2','token','hidden','','','5f8399efeab5a3140ff2a90adcdb3912ffb72aa5f8bc8448d583b199d9d8688c','1');");
...
E_D("replace into `ecs_shop_config` values('314','3','comments_number','text','','','1','1');");
...
E_D("replace into `ecs_shop_config` values('504','5','smtp_pass','password','','','0admin123','1');");
...
E_D("replace into `ecs_shop_config` values('604','6','template','hidden','','','jingdong2014','1');");
...
E_D("replace into `ecs_shop_config` values('620','6','sitemap','hidden','','','a:6:{s:19:\"homepage_changefreq\";s:6:\"hourly\";s:17:\"homepage_priority\";s:3:\"0.7\";s:19:\"category_changefreq\";s:6:\"hourly\";s:17:\"category_priority\";s:3:\"0.8\";s:18:\"content_changefreq\";s:6:\"weekly\";s:16:\"content_priority\";s:3:\"0.7\";}','0');");
...
E_D("replace into `ecs_shop_config` values('801','8','sms_shop_mobile','text','','','13692321391','1');");
...
E_D("replace into `ecs_shop_config` values('904','3','two_code','select','1,0','','1','1');");
E_D("replace into `ecs_shop_config` values('905','3','two_code_logo','file','','../images/weixin_img/logo/','../images/weixin_img/logo/weixin_logo.gif','1');");
E_D("replace into `ecs_shop_config` values('906','3','two_code_links','text','','','http://www.ecmoban.cn/mobile','1');");
E_D("replace into `ecs_shop_config` values('907','3','two_code_mouse','text','','','大京东商品','1');");
E_D("replace into `ecs_shop_config` values('908','2','editing_tools','select','fckeditor,ueditor,kindeditor','','kindeditor','1');");
E_D("replace into `ecs_shop_config` values('909','1','sign','text','','','10','50');");
E_D("replace into `ecs_shop_config` values('910','1','sign_time','text','','','7','51');");
E_D("replace into `ecs_shop_config` values('911','3','rand_order','select','1,0','','0','1');");
E_D("replace into `ecs_shop_config` values('912','2','wheat_coin','text','','','1','1');");
