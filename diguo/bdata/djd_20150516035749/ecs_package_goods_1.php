...
E_D("replace into `ecs_package_goods` values('5','141','0','1','1');");
E_D("replace into `ecs_package_goods` values('5','154','0','1','1');");
E_D("replace into `ecs_package_goods` values('5','155','0','1','1');");
E_D("replace into `ecs_package_goods` values('5','143','0','1','1');");
