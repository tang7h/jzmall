...
E_D("replace into `ecs_admin_action` values('136','1','sale_notice','');");
E_D("replace into `ecs_admin_action` values('137','1','sale_notice','');");
E_D("replace into `ecs_admin_action` values('138','1','notice_logs','');");
E_D("replace into `ecs_admin_action` values('139','3','baitiao_manage','');");
E_D("replace into `ecs_admin_action` values('140','0','seller_manage','');");
E_D("replace into `ecs_admin_action` values('141','140','seller_fields','');");
E_D("replace into `ecs_admin_action` values('142','140','seller_list','');");
E_D("replace into `ecs_admin_action` values('143','140','seller_yj_manage','');");
E_D("replace into `ecs_admin_action` values('144','140','store_cate_manage','');");
E_D("replace into `ecs_admin_action` values('145','140','store_manege','');");
E_D("replace into `ecs_admin_action` values('146','140','street_tags_manege','');");
