...
E_D("replace into `ecs_mail_templates` values('1','send_password','1','密码找回','<p>{\$user_name}您好！<br />\r\n<br />\r\n您已经进行了密码重置的操作，请点击以下链接(或者复制到您的浏览器):<br />\r\n<br />\r\n<a target=\"_blank\" href=\"{\$reset_email}\">{\$reset_email}</a><br />\r\n<br />\r\n以确认您的新密码重置操作！<br />\r\n<br />\r\n{\$shop_name}<br />\r\n{\$send_date}</p>','1420098291','0','template');");
...
E_D("replace into `ecs_mail_templates` values('15','sale_notice','1','降价通知','<p>{\$user_name}您好！<br />\r\n<br />\r\n您期望的商品 ({\$goods_name}) 已降价，请点击以下链接(或者复制到您的浏览器):<br />\r\n<br />\r\n<a target=\"_blank\" href=\"{\$goods_link}\">{\$goods_link}</a><br />\r\n<br />\r\n此信息无需回复！<br />\r\n<br />\r\n<br />\r\n{\$send_date}</p>','1408670541','0','template');");
E_D("replace into `ecs_mail_templates` values('16','b24dbb1505d653e077fb3f79b55035','1','1111','1111','1417835315','1418265672','magazine');");
