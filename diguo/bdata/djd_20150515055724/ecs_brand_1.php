...
E_D("replace into `ecs_brand` values('1','创维','','','http://','50','1');");
...
E_D("replace into `ecs_brand` values('77','安芙兰','1416787426554277577.jpg','','http://','50','1');");
E_D("replace into `ecs_brand` values('78','叙旧','','','','50','1');");
E_D("replace into `ecs_brand` values('79','4','','','','50','1');");
