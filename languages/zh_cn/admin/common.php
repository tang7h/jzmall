...
$_LANG['12_users_export'] = '导出会员列表';  //ecmoban模板堂 --zhuo
//ecmoban模板堂 --zhuo end
...
//用户白条
$_LANG['13_user_baitiao_info'] = '用户白条';
...
$_LANG['sale_notice_sms'] = '%s您好，您申请的商品%s已经降价，目前价格是%s';

$_LANG['11_back_cause'] = '退货原因列表';
$_LANG['12_back_apply'] = '退换货申请列表';

$_LANG['authorize'] = '[终身商业授权]';
$_LANG['nauthorize'] = '[非商业授权]';


$_LANG['01_app'] = "app管理";
$_LANG['01_advert_list'] = "APP图位管理";
