...
$_LANG['cfg_name']['sms_send'] = '商品降价时是否发送短信';
$_LANG['cfg_range']['sms_send']['1'] = '发短信';
$_LANG['cfg_range']['sms_send']['0'] = '不发短信';
$_LANG['cfg_name']['sms_ecmoban_user'] = '短信接口用户名';
$_LANG['cfg_name']['sms_ecmoban_password'] = '短信接口密码';

$_LANG['cfg_name']['sign'] = '有效退换货时间';
$_LANG['cfg_name']['sign_time'] = '有效退换货时间';

//by wang
$_LANG['cfg_name']['wheat_coin'] = '有麦币价值';
$_LANG['cfg_desc']['wheat_coin'] = '有麦币价值是指1有麦币抵人民币多少元';
