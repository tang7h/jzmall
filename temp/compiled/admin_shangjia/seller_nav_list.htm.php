...
?>
    <tr>
      ...
      <td align="center"><img src="images/<?php if ($this->_var['brand']['is_blank']): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_blank', <?php echo $this->_var['nav_list']['id']; ?>)" /></td>
