...
?>
  <tr>
    <td class="first-cell" nowrap="true">
      ...
      <span><?php echo $this->_var['module']['name']; ?></span>
      <?php else: ?>
    ...
    <td align="right" valign="top"> <?php if ($this->_var['module']['install'] == 1): ?> <span><?php echo $this->_var['module']['shipping_order']; ?></span> <?php else: ?> &nbsp; <?php endif; ?> </td>
    <td align="center" nowrap="true">
      <?php if ($this->_var['module']['install'] == 1): ?>
      <a href="shipping_area.php?act=list&shipping=<?php echo $this->_var['module']['id']; ?>"><?php echo $this->_var['lang']['shipping_area']; ?></a>
      <?php else: ?>
      <a href="shipping.php?act=install&code=<?php echo $this->_var['module']['code']; ?>">未启用</a>
      <?php endif; ?>
    </td>
  </tr>
