...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th>退换货号</th>
    <th><a href="#">退换货类型</a><?php echo $this->_var['sort_order_time']; ?></th>
    <th><a href="#">申请时间</a><?php echo $this->_var['sort_order_time']; ?></th>
    <th><a href="#">应退金额</a><?php echo $this->_var['sort_total_fee']; ?></th>
    <th><a href="#">实退金额</a><?php echo $this->_var['sort_total_fee']; ?></th>
    <th><a href="#">退换数量</a><?php echo $this->_var['sort_total_fee']; ?></th>
    ...
    <th><a href="#">申请人</a><?php echo $this->_var['sort_total_fee']; ?></th>
...
?>
  <tr>
    ...
    <td><?php echo $this->_var['order']['ret_id']; ?></td>
    <td> <?php if ($this->_var['order']['back']): ?>退货<?php if ($this->_var['order']['exchange']): ?>+换货<?php endif; ?><?php elseif ($this->_var['order']['exchange']): ?>换货<?php endif; ?></td>
    <td><?php echo $this->_var['order']['apply_time']; ?></td>
    ...
    <td align="right" valign="top" nowrap="nowrap"><?php echo $this->_var['order']['return_num']; ?></td>
    ...
    <td align="center" valign="top" nowrap="nowrap">
        <?php echo $this->_var['lang']['rf'][$this->_var['order']['return_status']]; ?>,<?php echo $this->_var['lang']['ff'][$this->_var['order']['refound_status']]; ?>
    </td> 
    <td align="center" valign="top" nowrap="nowrap"><?php echo $this->_var['order']['consignee']; ?></td>
    <td align="center" valign="top"  nowrap="nowrap">
     <a href="order.php?act=return_info&ret_id=<?php echo $this->_var['order']['ret_id']; ?>&rec_id=<?php echo $this->_var['order']['rec_id']; ?>"><?php echo $this->_var['lang']['detail']; ?></a>
