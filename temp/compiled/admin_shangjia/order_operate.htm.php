...
<table>
  ...
  <tr>
     <th>退款金额</th>
     <td>金额：<input name="refound_amount" type="text" size="10" value="<?php echo $this->_var['refound_amount']; ?>" />元&nbsp;&nbsp;运费:<input type="text" name="shipping" value="" size="6" />
          <input type="radio" name="is_shipping" />不退运费
          <input type="radio" name="is_shipping" />退运费
     </td>
  <tr>
  <tr>
    <th><?php echo $this->_var['lang']['label_handle_refund']; ?></th>
    <td><p><?php if (! $this->_var['anonymous']): ?>
      <label><input type="radio" name="refund" value="1" /><?php echo $this->_var['lang']['return_user_money']; ?></label><br><?php endif; ?>
     <label><input type="radio" name="refund" value="2" /><?php echo $this->_var['lang']['return_user_line']; ?></label><br>
  ...
  <tr>
    <td colspan="2">
      <div align="center">
        ...
        <input type="hidden" name="ret_id" value="<?php echo $this->_var['ret_id']; ?>"/>
