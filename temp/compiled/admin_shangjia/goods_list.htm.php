...
?>
  <tr>
    ...
    <td align="center"><?php echo $this->_var['goods']['wheat_coin']; ?></td>
    ...
    <td align="center">
      ...
      <a href="photoinfo_collect.php?act=photoinfo&goods_id=<?php echo $this->_var['goods']['goods_id']; ?>" title="采集淘宝图片和商品信息"><img src="images/icon_caiji.gif" width="16" height="16" border="0" /></a>
