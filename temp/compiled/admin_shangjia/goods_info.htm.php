      ...
      <form enctype="multipart/form-data" action="" method="post" name="theForm" >
        ...
        <?php echo $this->html_options(array('options'=>$this->_var['suppliers_list_name'],'selected'=>$this->_var['goods']['suppliers_id'])); ?>
         ...
         <?php endif; ?>
          ...
          <tr>
          <td class="label">支持有麦币:</td>
          <td><input type="text" name="wheat_coin" value="<?php echo $this->_var['goods']['wheat_coin']; ?>" size="20" />
            <br/><span class="notice-span">(商品有麦币为0时表示不支持有麦币抵付，设置的值表示最多可用有麦币数，值必须为正整数)</span></td>
        </tr>
