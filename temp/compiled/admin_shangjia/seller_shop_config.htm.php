...
?>
    ...
    <tr>
      ...
      <a href="http://www.zhiliaogou.cn/map" target="_blank"><span style="font-family:微软雅黑; color:#FFF; ">点击进行地图选址</span></a>
      </div>
      </td>
    </tr>
    <tr>
        <td class="micro-label">地图经纬:</td>
        <td style="line-height: 30px; line-width: 20px;width: 50px;">经度:<input type="text" name="map_api_x" value="<?php echo $this->_var['shop_info']['map_api_x']; ?>" /></td>
        <td>纬度:<input type="text" name="map_api_y" value="<?php echo $this->_var['shop_info']['map_api_y']; ?>" /></td>  
