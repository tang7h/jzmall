...
?>
        ...
        <li>
          <div class="lh-wrap">
            ...
            <div class="btns"><a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)" class="btn-buy">加入购物车</a><a id="coll647948" href="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>);" class="btn-coll">关注
            </a>
           <a chref="javascript:;" id="compareLink" class="f6">
	   <input id="<?php echo $this->_var['goods']['goods_id']; ?>" onClick="Compare.add(this, <?php echo $this->_var['goods']['goods_id']; ?>,'<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>','<?php echo $this->_var['goods']['type']; ?>', '<?php echo $this->_var['goods']['goods_thumb']; ?>', '<?php echo $this->_var['goods']['shop_price']; ?>', '<?php echo $this->_var['goods']['market_price']; ?>')" type="checkbox"  /><span>
	   <label for="<?php echo $this->_var['goods']['goods_id']; ?>">对比</label></span></a>
