...
class integrate
{
     ...
     * @return int
     */
    function add_user($username, $password, $email, $gender = -1, $bday = 0, $reg_date=0, $md5password='',$nick_name='')
    {
        /* 将用户添加到整合方 */
    ...
    function edit_user($cfg)
    {
        ...
        if ((!empty($cfg['nick_name'])) && $this->nick_name != 'NULL')
        {
            $values[] = $this->nick_name . "='" . $cfg['nick_name'] . "'";
        }
